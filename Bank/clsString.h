...
public:
	...
	static short CountCaptailLetter(string Name)
	{
		short count = 0;
	...
	short CountCaptailLetter()
	{
		return CountCaptailLetter(_Value);
	}

	static short CountSmallLetter(string Name)
	{
		short count = 0;
		for (short i = 0; i < Name.length(); i++)
		{
	...
	/*
	short CountLetterString(string Name, char Char1)
	{
		short count = 0;
	...
	short CountLetterString(string Name, char Char1)
	{
		return  CountLetterString(_Value,);
		{
	}
	*/
