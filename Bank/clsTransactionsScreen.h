...
private:
    enum enTransactionsMenueOptions {
        ...
        eShowTotalBalance = 3,eTransfers=4 ,eTransferLog=5,eShowMainMenue = 6
    };

    static short ReadTransactionsMenueOption()
    {
        cout << setw(37) << left << "" << "Choose what do you want to do? [1 to ]? ";
    ...
    static void _PerformTransactionsMenueOption(enTransactionsMenueOptions TransactionsMenueOption)
    {
        ...
        case enTransactionsMenueOptions::eTransfers:
        {
            system("cls");
